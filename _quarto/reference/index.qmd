...
| | |
| --- | --- |
| [CorpusProcessor](CorpusProcessor.qmd#pybiber.parse_utils.CorpusProcessor) | Main class that orchestrates corpus processing pipeline. |
...
| [spacy_parse](spacy_parse.qmd#pybiber.parse_utils.spacy_parse) | Parse a corpus (legacy public API). |
...
| | |
| --- | --- |
| [PybiberPipeline](PybiberPipeline.qmd#pybiber.pipeline.PybiberPipeline) | End-to-end convenience wrapper for common pybiber workflows. |
| [run_biber_from_folder](run_biber_from_folder.qmd#pybiber.pipeline.run_biber_from_folder) | One-liner: read -> parse -> biber() from a folder of .txt files. |
| [run_biber](run_biber.qmd#pybiber.pipeline.run_biber) | One-liner: parse -> biber() from an in-memory corpus DataFrame. |
...
| [mda_biber](mda_biber.qmd#pybiber.BiberAnalyzer.mda_biber) | Project results onto Biber's dimensions. |
